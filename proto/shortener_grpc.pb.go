...
const (
	...
	Shortener_Short_FullMethodName      = "/proto.Shortener/Short"
	Shortener_Get_FullMethodName        = "/proto.Shortener/Get"
	Shortener_GetLinks_FullMethodName   = "/proto.Shortener/GetLinks"
	Shortener_BatchShort_FullMethodName = "/proto.Shortener/BatchShort"
	Shortener_Delete_FullMethodName     = "/proto.Shortener/Delete"
	Shortener_GetStats_FullMethodName   = "/proto.Shortener/GetStats"
)
...
func _Shortener_GetLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServer).GetLinks(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
